...
| [02_architecture](L1/02_architecture.md) | Delivery model, core layers, and data flow between standard and workflows | Maintain |
...
| [05_workflows](L1/05_workflows.md) | Common maintenance tasks for standards, workflows, and self-hosted docs | Use & Maintain |
| [06_interfaces](L1/06_interfaces.md) | Public interfaces exposed through AGENTS.md, docs/workflows, and policy | Use & Maintain |
| [07_gotchas](L1/07_gotchas.md) | Drift risks, path-compatibility traps, and self-hosting caveats | Maintain |
| [08_security](L1/08_security.md) | Trust boundaries for external references, repo hygiene, and content safety | Maintain |
